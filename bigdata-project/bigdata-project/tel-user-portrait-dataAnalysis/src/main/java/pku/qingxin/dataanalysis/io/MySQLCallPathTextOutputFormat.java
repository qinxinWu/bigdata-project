 ...
 */
public class MySQLCallPathTextOutputFormat extends OutputFormat<Text,Text> {
...
/*
        ...
        public void write(Text key, Text value) throws IOException, InterruptedException {
            ...
            try {
                String insertSQL = "insert into callPath(rank,caller_id,callee_id,date_id,sum_call,sum_duration) values(?,?,?,?,?,?)";

...
public class CalleeLog {
    @RowKey
    private String rowkey;
    @Column(family = "callee")
    ...
    @Column(family = "callee")
    private String flag = "0";//1:主叫 0：被叫
    ...
    public CalleeLog(String call1, String call2, String calltime, String duration) {
        this.call1 = call1;
        this.call2 = call2;

            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>所有用户的通话情况查询<small> 包括：通话次数、通话时长、通话发起者（接收者）的地域热度</small></h2>
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group" >
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">
                                            ...
                                            <button type="button" class="btn btn-success" onclick="queryTotalData()">查询</button>
                                        </div>
                                    </div>
...
<script>
    ...
    function queryTotalData() {
        window.location.href = "/totalYearEcharts?calltime=" + $("#calltime").val();
